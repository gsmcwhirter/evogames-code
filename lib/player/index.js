                    ...
                    if (player._id)
                    {
                        ...
                        var creq = new couchdb.Request(function(response){
                            ...
                            else
                            {
                                ...
                                smtp.send("EvoGames System", player.email_history, "EvoGames Registration Confirmation", email_body, function (success){
            ...
            else
            {
                ...
                var creq = new couchdb.Request(function (response){
                    ...
                    else
                    {
                        ...
                        smtp.send("EvoGames System", player.email_history, "Welcome to EvoGames", email_body, function (success){
