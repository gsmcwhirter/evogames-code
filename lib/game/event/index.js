...
app.del(_base+"/:slug/controls/invites/withdraw/:invite", base.auth.loginCheckAjax, mw.forceEventAdminAjax, mw.forceEventNotOverAjax, withdrawInvite);
...
app.get(_base+"/:slug/controls/registrations", base.auth.loginCheck, mw.forceEventAdmin, mw.forceEventNotOver, requestForm);
app.del(_base+"/:slug/controls/registrations/remove/:registration", base.auth.loginCheckAjax, mw.forceEventAdminAjax, mw.forceEventNotOverAjax, denyRequest);
