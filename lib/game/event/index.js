                    ...
                    if (validation.valid){
                        ...
                        api.putDoc(event, function (response){
                            if (!response.error){
                                var msg = {
                                    from: "",
                                    subject: event.name+" ("+event.gamecode.toUpperCase()+" "+event.gamecode.name.toUpperCase()+")",
                ...
                api.uuids(function (uuids){
                    ...
                    api.putDoc(match, function (response){
                        if (!response.error){
                            var msg = {
                                from: "",
                                subject: "Match Submitted for "+req.event.name+" ("+req.event.gamecode.toUpperCase()+" "+req.event.gamecode.name.toUpperCase()+")",
                                to: [],
                                cc: []
                            };
            ...
            if (validation.valid){
                ...
                api.putDoc(match, function (response){
                    if (!response.error){
                        var msg = {
                            from: "",
                            subject: "Match Disputed for "+req.event.name+" ("+req.event.gamecode.toUpperCase()+" "+req.event.gamecode.name.toUpperCase()+")",
                            to: [],
                            cc: []
                        };
