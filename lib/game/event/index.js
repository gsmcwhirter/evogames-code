...
app.get(_base+"/:slug/edit", base.auth.loginCheck, editForm);
app.post(_base+"/:slug/edit", base.auth.loginCheck, editProcess);

app.del(_base+"/:slug/delete", base.auth.loginCheckAjax, deleteEvent);
...
app.get(_base+"/:slug/invite", base.auth.loginCheck, inviteForm);
app.put(_base+"/:slug/invite/add", base.auth.loginCheckAjax, addInvite);
app.del(_base+"/:slug/invite/withdraw/:invite", base.auth.loginCheckAjax, withdrawInvite);

app.get(_base+"/:slug/request", base.auth.loginCheck, requestForm);
app.del(_base+"/:slug/request/approve/:request", base.auth.loginCheckAjax, approveRequest);
app.del(_base+"/:slug/request/deny/:request", base.auth.loginCheckAjax, denyRequest);

app.get(_base+"/:slug/admin", base.auth.loginCheck, adminForm);
app.put(_base+"/:slug/admin/add", base.auth.loginCheckAjax, addAdmin);
app.del(_base+"/:slug/admin/remove/:admin", base.auth.loginCheckAjax, removeAdmin);
...
app.get(_base+"/:slug/matches/:matchid/edit", base.auth.loginCheck, editMatchForm);
app.post(_base+"/:slug/matches/:matchid/edit", base.auth.loginCheck, editMatchProcess);
app.del(_base+"/:slug/matches/:matchid/delete", base.auth.loginCheckAjax, deleteMatch);
