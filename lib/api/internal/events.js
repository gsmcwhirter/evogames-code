...
API.prototype.event_matches = function (options, callback){
    ...
    var creq = new this.couchdb.Request("GET", "/_design/event/_view/event_matches/"+util.encodeOptions(options), callback);
};

API.prototype.game_matches = function (options, callback){
    if (typeof(options) == "function") { callback = options, options = {}; }

    var creq = new this.couchdb.Request("GET", "/_design/event/_view/game_matches/"+util.encodeOptions(options), callback);
};

API.prototype.player_matches = function (options, callback){
    if (typeof(options) == "function") { callback = options, options = {}; }

    var creq = new this.couchdb.Request("GET", "/_design/event/_view/player_matches/"+util.encodeOptions(options), callback);
};
