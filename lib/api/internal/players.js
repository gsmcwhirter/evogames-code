...
API.prototype.avatars = function (options, callback){
    ...
    if (typeof options.keys != "undefined"){
        creq = new this.couchdb.Request("POST", "/_design/player/_view/avatars/", {"Content-type": "application/json", data: JSON.stringify({keys: options.keys})}, callback);
    }
    else {
        creq = new this.couchdb.Request("GET", "/_design/player/_view/avatars/"+util.encodeOptions(options), callback);
    }
}
...
API.prototype.handles = function (options, callback){
    ...
    var creq = new this.couchdb.Request("GET", "/_design/player/_view/handles/"+util.encodeOptions(options), callback);
};

API.prototype.emails = function (options, callback){
    if (typeof(options) == "function") { callback = options, options = {}; }

    var creq = new this.couchdb.Request("GET", "/_design/player/_view/emails/"+util.encodeOptions(options), callback);
};

API.prototype.pendingEmails = function (options, callback){
    if (typeof(options) == "function") { callback = options, options = {}; }

    var creq = new this.couchdb.Request("GET", "/_design/player/_view/pending_emails/"+util.encodeOptions(options), callback);
};

API.prototype.loginTokens = function (options, callback){
    if (typeof(options) == "function") { callback = options, options = {}; }

    var creq = new this.couchdb.Request("GET", "/_design/player/_view/login_tokens/"+util.encodeOptions(options), callback);
};

API.prototype.recent = function (options, callback){
    if (typeof(options) == "function") { callback = options, options = {}; }

    var creq = new this.couchdb.Request("GET", "/_design/player/_view/recent_registrations/"+util.encodeOptions(options), callback);
};
