var crypto = require('crypto'),
    ...
    TZDate = require('../node-zoneinfo/lib/zoneinfo');
...
var encodeOptions = function (options) {
    if (typeof(options) == "object" && options !== null) {
        options.forEach(function(val, name){
            ...
            if (name == "key" || name == "startkey" || name == "endkey" || name == "include_docs" || name == "descending"){
...
var date = function(string_or_int, timezone){
    ...
    if (timezone) d.setTimezone(timezone);
    return d;
};

var timezones = function (country_code){
    return TZDate.listTimezones(country_code);
};
