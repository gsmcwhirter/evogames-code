...
app.get("/:code/controls/owners", base.middleware.loginCheck, checkGroupAdmin, forceGroupOwner, ownersForm);
app.put("/:code/controls/owners/add", base.middleware.loginCheck, checkGroupAdmin, forceGroupOwner, addOwner);
app.del("/:code/controls/owners/resign", base.middleware.loginCheck, checkGroupAdmin, forceGroupOwner, resignOwnership);
...
app.put("/:code/controls/invites/add", base.middleware.loginCheck, checkGroupAdmin, forceGroupAdminAjax("invites"), addInvite);
