...
app.get("/controls/:code/pending", base.middleware.loginCheck, editForm);

app.get("/controls/:code/members", base.middleware.loginCheck, editForm);

app.get("/controls/:code/invite", base.middleware.loginCheck, editForm);
