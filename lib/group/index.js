...
app.get("/controls", base.middleware.loginCheck, base.page('group/controls', [{href: "/", text: "Home"}, {href: "/group", text: "Groups"}, {href: "/group/controls", text: "Manage"}]));

app.get("/controls/:code", base.middleware.loginCheck, groupControlForm);
...
function groupControlForm(req, res, next){
    var locals = {};
