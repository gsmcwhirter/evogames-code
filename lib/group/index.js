...
app.get("/:code/controls", base.auth.loginCheck, forceGroupAdmin(), groupControls);

app.get("/:code/controls/edit", base.auth.loginCheck, forceGroupAdmin("edit"), editForm);
app.post("/:code/controls/edit", base.auth.loginCheck, forceGroupAdmin("edit"), editProcess);

app.get("/:code/controls/owners", base.auth.loginCheck, forceGroupOwner, ownersForm);
app.put("/:code/controls/owners/add", base.auth.loginCheck, forceGroupOwner, addOwner);
app.del("/:code/controls/owners/resign", base.auth.loginCheck, forceGroupOwner, resignOwnership);

app.get("/:code/controls/requests", base.auth.loginCheck, forceGroupAdmin("requests"), pendingForm);
app.del("/:code/controls/requests/:alias@:handle/approve", base.auth.loginCheck, forceGroupAdminAjax("requests"), approvePending);
app.del("/:code/controls/requests/:alias@:handle/deny", base.auth.loginCheck, forceGroupAdminAjax("requests"), denyPending);

app.get("/:code/controls/members", base.auth.loginCheck, forceGroupAdmin("members"), membersForm);
app.get("/:code/controls/members/:alias@:handle", base.auth.loginCheck, forceGroupAdmin("members"), permissionsForm);
app.post("/:code/controls/members/:alias@:handle", base.auth.loginCheck, forceGroupAdmin("members"), permissionsProcess);
app.del("/:code/controls/members/:alias@:handle/remove", base.auth.loginCheck, forceGroupAdminAjax("members"), removeMember);

app.get("/:code/controls/invites", base.auth.loginCheck, forceGroupAdmin("invites"), inviteForm);
app.put("/:code/controls/invites/add", base.auth.loginCheck, forceGroupAdminAjax("invites"), addInvite);
app.del("/:code/controls/invites/@:handle", base.auth.loginCheck, forceGroupAdminAjax("invites"), withdrawInvite);
...
app.param('code', function(req, res, next, code){
    ...
    api.groups.codes({include_docs: true, key: code.toLowerCase()}, function (response){
        if (!response.errors && response.rows.length){
            ...
            checkGroupAdmin(req, res, function (err){
                if (err){
                    next(err);
                }
                else {
