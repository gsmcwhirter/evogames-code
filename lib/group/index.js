...
app.get("/:code/edit", base.middleware.loginCheck, editForm);
app.post("/:code/edit", base.middleware.loginCheck, editProcess);
...
function displayProfile(req, res, next){
    ...
    if (req.group){
        ...
        res.render("group/profile", {group: group, gdescription: description, crumbs: crumbs});
    }
    else {
        res.redirect("search");
    }
